...
future research into protecting against adversaries. I think the usefulness
is primarily that it's usable as adversarial domain augmentation, where you
can give adversarial examples as new training inputs. And this is pretty
different from a reasonable defense.
