...
That's just how we are as a team.

As another example, [Number Hunting](https://www.puzzlesaremagic.com/puzzle/number-hunting/) from
...
When I checked the
[stats for Number Hunting](https://www.puzzlesaremagic.com/stats/number-hunting/), I was not surprised that a teammate team got the fastest solve.
...
from Galactic. It will be less **WHOOSH** *Galactic Trendsetters!* **NYEEEEOW**,
...
solvers know what good puzzles look like, but that still leaves creating good
puzzles, on top of all the other organization involved in running a Hunt.
