...
a Tiger tracking spreadsheet, asking Safari meta solvers if we could find
them and reconstructing the solve from the spreadsheet if we couldn't.
Once the Safari Adventure metameta unlocked, we transferred our data into
that sheet, and in the process of doing so, someone got the Tyger Tyger
a-ha right away, which just left solving the remaining Safari metas.

During this time, we had one PennyPass leftover. In the Hunt, we would
...
hasn't come back yet, and I don't think it should. Our PennyPass strategy
...
to increase width was to unlock new rounds, or use PennyPasses. 
