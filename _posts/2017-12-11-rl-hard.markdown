...
from the past few years, because their work is most visible to me.
...
I want deep RL to work. I want people to keep researching it.
I certainly don't want to discourage people
from joining the field. At the same time, I want people to know what they're
getting into.
So that if they fail to get positive results for a month, they know it's not
necessarily their fault.

This post is broadly divided into three sections: why deep RL doesn't work,
why deep RL sometimes does work, and how deep RL could work better in the
future. I know the post is a bit long, but I'd appreciate it if you'd read
to the end before replying.

A few final notes:

* When listing why deep RL doesn't work, I cite several papers.
**I like all of the papers I cite.** In many cases, I cite only because they
give compelling negative examples.

* I use "reinforcement learning" and "deep reinforcement learning"
interchangeably. **I am criticizing deep reinforcement learning in particular.**
The papers I cite usually represent the agent with a deep neural net, and
although the criticisms *may* apply to linear RL or tabular RL, I'm not
confident they generalize that far.
...
deep RL was able to learn these running behaviors.

At the same time, the fact that we needed to use 6400 CPU hours to learn these
behaviors is a bit disheartening. It doesn't feel like these gaits should
require that much computation to learn.
...
I find it's hard to stay motivated when I compare RL's performance to, well,
...
surpass classical robotics techniques, by learning behaviors
that apply and adapt to general environments.
...
Nothing I work on is near that visually impressive.
