...
of learning non-realistic tasks, but that's a perfectly acceptable trade-off.

The difficulty is that such a real-world prior is very hard to design.
However, I think there's a good case for optimism.
