...
(Link to rebuttal section earlier? Or mention that it exists so that people
know it's there?)

(Remove the second video because it mostly confuses people.)
...
RL or tabular RL, but I'm not confident enough to claim those criticisms
generalize.
...
(TODO: Add a point about how you can either optimize for performance, or optimize
for research contribution, and ideally you do both, but if you just want the
former, RL isn't great.)
...
presentation where they said they didn't do machine learning.
