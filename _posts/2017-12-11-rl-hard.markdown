...
People care about deep RL because it has a lot of potential.

Unfortunately, deep RL is pretty awful, for so and so reasons.

Despite this, I'm optimistic things can get better, and here are some
plausible paths.

It seems more consistent to just describe it as awful, but I don't want
people to think deep RL is useless, or that it doesn't deserve research.
