...
But What About All Reinforcement Learning Success Stories?
-------------------------------------------------------------------

Here are some high-profile reinforcement learning success stories, in
...
features.
* The backgammon bot TD-Lambda, from the 80s.

(I'm sure I'm missing some, but let's work with this list for now.)
