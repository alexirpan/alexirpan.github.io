...
Companions from currently running audio plays. From left to right: Tick Tock,
Twilight, Trixie, Roseluck, Derpy, Doctor Whooves. By Lilla Dessert.
{: .centered }
...
I highly recommend listening to the audio over reading the transcript. The power
comes from the delivery and the soundtrack, not the script.
...
Move this transcript to the appropriate spot.

Let's begin. The history of the green isles, and the island of clover in particular
in the year 517 there was a great exodus from trottingham. Many ships
headin towards Canterlot in efforst tos escape seom wild magic that threatened the land.
The blight stretched from the shored of Hoofany to the fertile cesenccet of Glyphmakr.
Ponies, zebras and griffons alike filled its hull as it crossed the

safer shores. The air filled witih whhisperes of what was causign the strange, dark occurrences,
the birds would stop singing, farm animals would beocme resless, crops would die, and
ponies would go missing. It got to the point where no one could even leave their homes
or tend to their fields. So as they sailed across the sea, hoping for somewhere
safe, they dared to wish that such evil would be left behind, They were wrong.

But among them as a foal. His name was Mayhew. Mayhew was tiny and undernourished
from a life under the dark, his mother held him in the hull of their ship, huddled and afriad.
AS they sailed, fortunately, the water was smooth form

<button
    class="spoiler-control"
    title="Click to show transcript"
    toggle1="Show Transcript"
    toggle2="Hide Transcript">
</button>
{: .centered }
