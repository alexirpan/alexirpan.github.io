...
From just a musical standpoint, we get better music - cool! From an overall standpoint, it's more mixed.
...
In the comparison above (movie top, original shot below), obviously the main difference is the addition of the truck
...
Intent of that form can shine even when mediated by computers.

I don't think people really care about AI or not. It's more of a proxy complaint
...
someone with vision would do the work on their own.
...
We don't have them yet and would find ways to complain about them even if we did. Until then, in the uncanny valley of competence, at least the flawed can be kings.
