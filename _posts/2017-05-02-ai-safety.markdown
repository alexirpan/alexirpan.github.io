...
I also find it easy to believe that the problem is hard. It's generally hard
to prove a negative. If computer security has taught us anything, it's that
despite having a core kernel of extremely well tested crypto, a lot of systems
are just horribly vulnerable all the time. The attack surface is almost always
larger than you imagine it, because the attack surface is your imagination plus
the imagination of everybody else interested in breaking it.
...
People reading HPMoR and then rapidly entering rationalist subculture.

The canonical topics: AI unboxing, value alignment, utilitarianis, cryonics,
nootropics, cognitive biases, etc.
