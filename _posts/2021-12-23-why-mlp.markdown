...
ideas that are hard to explain. This post is going to long, so let's get started.
...
Then there was the endless fan music, which ranged from remixing musical numbers from the show,
...
Of course, the convention center was getting used by other events too. That year, it was co-located with
...
game receiving active development, I realized this fandom actually might never die. Where are these people even coming from?
