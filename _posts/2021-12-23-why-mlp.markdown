...
In our reality, it didn't. That's thanks to 4chan,
and that's as good a segue as I'm going to get to discuss that.


"I Know My Horse Will Never Come In"
----------------------------------------------------------------------------------------------

I don't go to 4chan. In my entire time on the Internet, 4chan's been known as the cesspool of the
Internet, and I'm sure the 4chan users would agree. I'm not interested in doing a deep dive on
4chan culture, I quite liked [Dale Beran's](https://medium.com/@DaleBeran/4chan-the-skeleton-key-to-the-rise-of-trump-624e7cb798cb)
essay about 4chan and Trump, which I will briefly quote below.
...
In short, 4chan is the home of mostly men who hopelessness runs so deep that they cannot find solace anywhere else.
(Just in case a 4channer does run across this - yes, I know that /pol/ is not all of 4chan, and not
everyone on 4chan is part of the alt-right. The relevant part is the learned helplessness, the kind
that lives in a 2016-era Sanders-or-Trump voter.)
...
by shitting on trash, maybe get a few memes out of it to troll other parts of 4chan.

They get a few episodes in and realize, with dawning horror, that the show's actually pretty good.

From there, word spreads quickly, 4chan mods have to make a /mlp/ containment board to stop it
from polluting the serious and dignified discussion of other cartoons, it leaks out of 4chan
into the wider word, and you know the rest.

The vast majority of bronies have little if any connection to 4chan. Once the fandom got going, once
it won the cosmic lottery of getting people to give it a chance, it became self-sustaining.
The premise was too novel to ignore. Not the premise of the show: the premise of the
*fandom*.
...
As much as I've consumed MLP content, I never really found the sense of fellowship that so many people said
...
Of course, there was drama. There's always drama.
