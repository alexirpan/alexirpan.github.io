...
it's almost exclusively about Friendship is Magic, the Generation 4 cartoon. *No*, it's not some fetish thing,
...
In short, yeah, *My Little Pony: Friendship is Magic* is an advertising vehicle, but it's a fun advertising vehicle. Sometimes making something good is the right way to make money.
...
(Terry Pratchett, supposedy, but I haven't found a primary source.)
{: .centered }
...
speaking line. The character designs for Derpy, Lyra, Bon-Bon, Octavia, and Vinyl were set instantly,
but all the canon stories afterwards were influenced heavily by what fans wanted to see.
Then there was the endless fan music sampling
