...
Yes, it's an advertising vehicle to sell toys, but it's a well-animated advertising vehicle. The character
...
However, quality by itself is no guarantee of fandom
Quality

Fans often attribute the characters to Lauren Faust's influence as a showrunner, thanks to her prior work
on *The Powerpuff Girls* and *Foster's Home for Imaginary Friends*. It's pretty unclear how true that is,was announced as the lead for an upcoming MLP reboot.
