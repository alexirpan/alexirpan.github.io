...
*Before writing this post, I had read the paper and written a few Facebook posts
about the strategy, but nothing formal. This post, including all code, was written
...
but that note is blank. In the public key crypto implementation,
...
The most important part of this paper is not the strategies, it's the existence
of the paper itself.
