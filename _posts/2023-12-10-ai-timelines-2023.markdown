...
Extrapolating that progress would overestimate future progress.
...
![Sigmoid curve](/public/ai-timelines-2023/sigmoid.png)
{: .centered }
...
found say manufacturing is 10% to 30% of jobs, depending on country.)
...
a superintelligent software assistant. I find the latter more worrying than the former.
