...
their datasets.
[One of my first papers](https://sites.google.com/view/graspgan) was on the subject, and
...
and becomes less important later.
...
One thing this does impact is our ability to evaluate models.
...
## The "Scaling is a Research Problem" Bear
...
a research problem of its own, that is not solved by scale, and eventually we get some
claim like "solving scaling is AGI complete".
...
Project (get more enriched uranium). But I don't have any argument against it past that.
